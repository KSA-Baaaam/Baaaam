...
export function Hero() {
  return (
    <section className="border-b border-hero-border bg-[#ebf6ef]">
      <div className="mx-auto grid w-full min-w-0 max-w-7xl overflow-hidden md:min-h-[470px] md:grid-cols-[1.02fr_0.98fr] md:items-center">
        <div className="w-full min-w-0 px-5 py-10 min-[375px]:px-6 sm:px-8 sm:py-14 md:pl-8 md:pr-10 lg:pr-16">
          ...
          <p className="mt-5 max-w-[34rem] whitespace-pre-line text-base leading-7 text-ink-muted sm:mt-6 sm:text-lg sm:leading-8">
        ...
        <div className="relative flex h-full min-h-[230px] w-full min-w-0 items-end justify-center px-5 pt-0 min-[375px]:min-h-[260px] sm:min-h-[320px] sm:px-8 md:min-h-[470px]">
